#Thomas Lawless CIS261 ProjectPhase4
...
def GetUserName():
    ...
    username = input("Enter a username or 'End' to stop: ")
    return username 
...
def GetUserPassword():
    ...
    while True:
        pwd = input("Enter password or 'End' to quit: ")
        if pwd == 'End':
            return None
        else:
            return pwd
...
def GetUserRole():
     ...
     while True:
         ...
         if UserRole.lower() == 'admin' or UserRole.lower() == 'user':
            ...
            UserRole = input("Invalid input. Enter role (Admin or User): ")
